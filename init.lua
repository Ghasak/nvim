...
-- appearance
--vim.api.nvim_set_hl(0, 'WhichKeyBorder', {bg='#3B4252', fg='#5E81AC'})
--vim.api.nvim_set_hl(0, 'WhichKeyBorder', {bg='#3B4252'})
-- vim.api.nvim_set_hl(0, 'TelescopeNormal', {bg='#3B4252'})
-- vim.api.nvim_set_hl(0, 'TelescopeBorder', {bg='#3B4252'})
--

-- This will control the Breadcrumbs
vim.cmd('highlight WinBar guibg=#2c333c')
vim.cmd('highlight WinBarNC guibg=#2c333c')
