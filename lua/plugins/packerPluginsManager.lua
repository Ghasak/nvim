...
return packer.startup(function(use)
  ...
  use({ "nvim-treesitter/playground", event = "InsertEnter" })
  ...
  use({ "christoomey/vim-system-copy", opt = true, event = "InsertEnter" })
  -- ==========================================================================
  ...
  --     })
  --   end})
  use({ "ggandor/lightspeed.nvim", opt = true, event = "CursorMoved"
  })
  -- ===========================================================================
  ...
  use({ "vim-scripts/ReplaceWithRegister", opt = true, event = "InsertEnter" })
  ...
  use({ "gennaro-tedesco/nvim-peekup", event = "InsertEnter" })
  -- ===========================================================================
  --                            Git and Diff
  -- ===========================================================================
  use({
  ...
  use({ "wellle/context.vim", event = "InsertEnter", cmd = { "ContextEnable" } })
  -- ==========================================================================
  -- 	                      Programming Language Servers
  -- =========================================================================
  use({ "folke/neodev.nvim", module = "neodev", ft = "lua", event = "InsertEnter" })
  -- lsp_signature.nvim
  use({
  ...
  use({ "RishabhRD/nvim-cheat.sh", event = "InsertEnter"
  })
  -- ===========================================================================
  --                         For Editor
  -- ===========================================================================
  -- Allow making tables in Markup-language (*.md) files.
  use({ "dhruvasagar/vim-table-mode", event = "InsertEnter" })
  ...
  -- ==========================================================================
  use({ "/Users/gmbp/Desktop/devCode/plugins/auto.nvim", disable = true })
  -- ==========================================================================
