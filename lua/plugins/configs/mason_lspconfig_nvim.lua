...
M.setup = function()
    ...
    local rust_tools_settings = require(
                                    "plugins.configs.lsp.custom_servers.rust_analyzer_server")
    -- ------------------------------------------------
    ...
    if not mason_status_ok then
        vim.notify("Couldn't load Mason-LSP-Config" .. mason_lspconfig,
    ...
    require("mason-tool-installer").setup {
        ensure_installed = {
            "codelldb", "stylua", "shfmt", "shellcheck", "black", "isort",
            "prettierd"
        },
        auto_update = false,
        run_on_start = true
    ...
    mason_lspconfig.setup_handlers({
        ...
        ["lua_ls"] = function()
            local sumneko_settings =
                require "plugins.configs.lsp.custom_servers.sumneko_lua_server"
