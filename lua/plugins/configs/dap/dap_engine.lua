...
M.python_debuger_setup = function(dap)
    ...
    local python_adapters_setting_tbl = require(
                                            "plugins.configs.dap.dap_custom_languages_settings.dap_python_settings").dap_adapters_python_fn()
    local dap_configurations_python_tbl = require(
                                              "plugins.configs.dap.dap_custom_languages_settings.dap_python_settings").dap_configurations_python_fn()
    local python_dap_fn = require(
                              "plugins.configs.dap.dap_custom_languages_settings.dap_python_settings").python_dap_fn
...
M.rust_debuger_setup = function(dap)
    ...
    require(
        "plugins.configs.dap.dap_custom_languages_settings.dap_rust_settings").setup(
        dap)
...
M.cpp_debuger_setup = function(dap)
    require("plugins.configs.dap.dap_custom_languages_settings.dap_cpp_settings").setup(
        dap)
