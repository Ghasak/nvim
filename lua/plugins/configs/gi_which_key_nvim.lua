...
M.config = function()
  ...
  local setup = {
    ...
    delay = function(ctx) return ctx.plugin and 0 or 2000 end,
  ...
  -- Here is passing the setup option which the magic happens
  which_key.setup(setup)
  -- Now the configurations for the key mapping that customized by the user {ME}
  which_key.add {
